...
fun fim_cinco(modifier: Modifier = Modifier) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Tudo que aconteceu não passou de um sonho muito real. Mas conforme se passam os dias, tudo aquilo que você sonhou, se torna realidade, pouco a pouco.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
