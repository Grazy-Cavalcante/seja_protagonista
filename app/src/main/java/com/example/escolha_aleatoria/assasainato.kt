...
fun assassinato(modifier: Modifier = Modifier) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Image(
                        painterResource(R.drawable.morte),
                        contentDescription = "faca com sangue",
                    ...
                    Text(
                        text = "Alguém que esteve ao seu lado durante toda a sua vida, infelizmente foi assassinado.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
