...
fun ganancia(navController: NavHostController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Image(
                        painterResource(R.drawable.ganancia),
                    ...
                    Text(
                        text = "Você é contratado para fazer algo que não condiz com seus princípios, por uma grande quantia de dinheiro.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
