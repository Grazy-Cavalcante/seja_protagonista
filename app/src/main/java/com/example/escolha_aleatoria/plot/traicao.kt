...
fun traicao(navController: NavHostController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Image(
                        painterResource(R.drawable.traicao),
                        contentDescription = "pessoa com uma máscara",
                        modifier = Modifier
                            .size(120.dp)
                            .offset(y = (-45).dp)
                    ...
                    Text(
                        text = "Você descobre que foi traído(a) pela pessoa que mais amou.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
