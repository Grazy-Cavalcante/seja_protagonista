...
fun profissao ( navController: NavController){
    val telasSorteio = listOf("cientista", "empresario","escritor","fotografo","medico","psicologo","advogado","engenheiro","desenvolvedor")
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Image(
                        painterResource(R.drawable.profissao),
