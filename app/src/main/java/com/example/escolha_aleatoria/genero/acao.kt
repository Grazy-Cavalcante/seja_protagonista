...
fun acao (navController: NavController){
...
//yourContent
        ...
        val imagem = painterResource(id = R.drawable.azul_escuro)
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Image(
                        painterResource(R.drawable.acao),
                        contentDescription = "Revolver e explosivos",
                    ...
                    Text(
                        text = "Uma trama cheia de\n adrenalina está para começar...",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
