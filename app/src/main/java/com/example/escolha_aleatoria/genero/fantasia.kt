...
fun fantasia(navController: NavController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Image(
                        painterResource(R.drawable.fantasia),
                        contentDescription = "livro mágico",
                    ...
                    Text(
                        text = "Quem disse que não\n podemos sair um pouco da realidade?",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
