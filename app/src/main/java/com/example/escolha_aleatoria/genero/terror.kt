...
fun terror(navController: NavController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Image(
                        painterResource(R.drawable.bats),
                        contentDescription = "Lua, com morcegos voando",
                    ...
                    Text(
                        text = "Tome cuidado!\nUma aventura sangrenta está para começar...",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
