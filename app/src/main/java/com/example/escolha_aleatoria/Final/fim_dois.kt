...
fun fim_dois(navController: NavHostController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text ="10  anos se passaram após todos os acontecimentos, arrependimento preenche seu coração, pois depois de tudo, você perdeu algo valioso, sua visão." ,
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
