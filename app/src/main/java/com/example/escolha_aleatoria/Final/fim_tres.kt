...
fun fim_tres (navController: NavHostController){
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Depois de tudo o que aconteceu, você foi internado(a) em uma clínica psiquiátrica, pois todos duvidam da sua sanidade. ",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
