...
fun fim_um(navController: NavHostController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "No final, você está rico, viajando o mundo todo, comprando tudo o que sempre quis. As vezes ser o vilão da história vale a pena. ",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
