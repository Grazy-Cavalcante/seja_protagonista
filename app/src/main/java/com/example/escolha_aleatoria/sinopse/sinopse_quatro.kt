package com.example.escolha_aleatoria.sinopse
...
fun sinopse_quatro (navController: NavHostController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = " Uma noite comum, você caminha de volta para casa, mas percebe que está sendo seguido (a) por um carro preto. Em meio ao desespero, começa a correr, mas sente alguém te imobilizando, após isso tudo fica escuro.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
