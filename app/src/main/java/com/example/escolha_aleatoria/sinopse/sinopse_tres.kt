...
fun sinopse_tres(navController: NavHostController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Um dia tempestuoso, gotas de chuva caiam impiedosamente. Você escuta um barulho alto, batidas em sua porta. Quando aberta, uma pessoa desconhecida aparece em sua frente totalmente molhada.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
