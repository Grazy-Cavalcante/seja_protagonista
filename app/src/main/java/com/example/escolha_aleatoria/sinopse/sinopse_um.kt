...
fun sinopse_um(navController: NavHostController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Um dia nublado em Nova York, o céu estava refletindo seus sentimentos. Em meio a um turbilhão de emoções você esbarra com seu amigo de infância, e a partir desse momento, sua vida muda drasticamente.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
