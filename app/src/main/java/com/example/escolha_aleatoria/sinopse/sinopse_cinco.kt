...
fun sinopse_cinco(navController: NavHostController) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Uma reunião como todas as outras, até que uma notícia inesperada te deixa abismado(a), você terá que trabalhar lado a lado da pessoa que mais detesta.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
