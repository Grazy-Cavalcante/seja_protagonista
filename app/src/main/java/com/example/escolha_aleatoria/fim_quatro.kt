...
fun fim_quatro(modifier: Modifier = Modifier) {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Meses após a grande reviravolta, você retorna para sua cidade natal, depois de ter deixado tudo para trás, pois cansou de viver aprisionado(a) dentro de sua própria mente.",
                        style = TextStyle(
                            color = black,
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
                ...
                Row( modifier = Modifier
                    ...
                    Button(
                        ...
                        modifier = Modifier.height(70.dp).width(300.dp).offset(y = (-40).dp),
